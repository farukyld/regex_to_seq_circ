...
print_cyan("creating the formal definition of sequential circuit and serializing")
circt_dict = ast_to_formal_circuit.circuit_dict(ast_root, False, pattern)
print_green("created, serialized")

print_cyan(f"dumping formal definition into {path_shortcuts.TEST_0_JSON_PATH}")
